...
export default function DoctorSettings() {
  ...
  const saveName = () => {
    localStorage.setItem('medisync_name', name.trim() || 'Doctor');
  ...
  return (
    <DashboardLayout role="doctor">
      <div className="space-y-6 max-w-2xl">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Doctor Settings</h1>
          <p className="text-slate-500 mt-1">Manage profile preferences and account security.</p>
        </div>
        ...
        <div className="bg-white border border-rose-100 rounded-2xl p-6 shadow-sm space-y-4">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1">
              This permanently deletes your doctor account and associated appointment records.
            </p>
          </div>
